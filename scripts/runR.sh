...
#SBATCH --output=/scratch/crs12448/AP_WO_21/Diff_Coex/logs/log.%j	    # Standard output and error log - # replace cbergman with your myid
#SBATCH --mail-user=christopher.smaga@uga.edu                    # Where to send mail - # replace cbergman with your myid
#SBATCH --mail-type=END,FAIL                            # Mail events (BEGIN, END, FAIL, ALL)

cd /scratch/crs12448/AP_WO_21/R

ml R/4.3.1-foss-2022a

export R_LIBS=/home/crs12448/R/x86_64-pc-linux-gnu-library/4.3

R CMD BATCH ~/MEVE/scripts/differential_coexpression.R
