...
hisat2 -x /scratch/crs12448/GATOR_GENOME/Amiss_ref  -p 10 --rna-strandness FR --dta -q -1 $OUTDIR/TrimmedReads/${sample}_1_val_1.fq -2 $OUTDIR/TrimmedReads/${sample}_2_val_2.fq -S $OUTDIR/Alignment/HISAT2/SAM/${sample}.sam --summary-file $OUTDIR/Alignment/HISAT2/Stats/${sample}_HISAT2_alignment_summary
