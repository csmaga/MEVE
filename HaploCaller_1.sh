...
#SBATCH --output=/scratch/crs12448/MEVE/Logs/GATK_haplo_1.o    # Standard output and error log - # replace cbergman with your myid
#SBATCH --error=/scratch/crs12448/MEVE/Logs/GATK_haplo_1.e
...
for i in S242 S246 S247 S252 S256;
do
