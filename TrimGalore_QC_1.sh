...
#SBATCH --job-name=MEVE_trimming_1
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=4
#SBATCH --mem=24G
#SBATCH --time=48:00:00
#SBATCH --output=/scratch/crs12448/MEVE/Logs/trim_1.o
#SBATCH --error=/scratch/crs12448/MEVE/Logs/trim_1.e
...
for dir in S392 S319	S280 S249 S388; do
  echo "Starting $dir"
  cd $dir
