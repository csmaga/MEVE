...
# trim adapter sequences from corrected fastq files, setting strigency to 3 (only trimmed if at least 3 bases match adaptor sequence) based on STIM2014 (from MDH and SLB)
