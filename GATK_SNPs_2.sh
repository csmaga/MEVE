...
#SBATCH --output=/scratch/crs12448/MEVE/Logs/GATK2_dup.o    # Standard output and error log - # replace cbergman with your myid
#SBATCH --error=/scratch/crs12448/MEVE/Logs/GATK2_dup_new.e
