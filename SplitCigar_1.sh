...
#SBATCH --output=/scratch/crs12448/MEVE/Logs/GATK_cigar2_1.o    # Standard output and error log - # replace cbergman with your myid
#SBATCH --error=/scratch/crs12448/MEVE/Logs/GATK_cigar2_1.e
