...
#SBATCH --job-name=MEVE_trimming_3
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=4
#SBATCH --mem=24G
#SBATCH --time=48:00:00
#SBATCH --output=/scratch/crs12448/MEVE/Logs/trim_3.o
#SBATCH --error=/scratch/crs12448/MEVE/Logs/trim_3.e
...
for dir in S263 S231 S316 S246	S432; do
  echo "Starting $dir"
  cd $dir
