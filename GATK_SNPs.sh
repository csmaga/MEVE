...
#SBATCH --output=/scratch/crs12448/MEVE/Logs/GATK_genotype_new.o    # Standard output and error log - # replace cbergman with your myid
#SBATCH --error=/scratch/crs12448/MEVE/Logs/GATK_genotype_new.e
